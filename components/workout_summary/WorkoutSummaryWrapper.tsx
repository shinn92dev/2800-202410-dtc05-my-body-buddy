            ...
            if (userId) {
                try {
                    ...
                    if (response.data) {
                        ...
                        const weeklyWorkoutsData = getWeeklyWorkouts(achievedWorkouts, date);
                        ...
                        const monthlyAverageCalories = calculateMonthlyAverageCalories(achievedWorkouts, date);
                        setMonthlyAverageCalories(monthlyAverageCalories);
                        console.log("Monthly average calories:", monthlyAverageCalories);

                        const dailyCalories = calculateDailyCalories(achievedWorkouts, date);
                        ...
                        const totalCalories = calculateTotalCalories(achievedWorkouts);
