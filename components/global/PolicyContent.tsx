export default function PolicyContent() {
    return (
        <div>
            <p className="text-right mt-3">Last updated: May 16, 2024</p>
            <p className="mt-5">
            ...
            <h2 className="font-bold text-2xl md:text-3xl mt-10">
            ...
            <h3 className="font-bold text-xl md:text-2xl mt-5">Definitions</h3>
            ...
            <ul className="list-disc px-10">
                ...
                <li>
                    <p className="mt-3">
                        ...
                        &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                        or &quot;Our&quot; in this Agreement) refers to My Body
                        Buddy.
                    </p>
                </li>
                <li>
                ...
                <li>
                    <p className="mt-3">
                        <strong>Country</strong> refers to: British Columbia,
                        Canada
                    </p>
                </li>
                <li>
                ...
                <li>
                    <p className="mt-3">
                        <strong>Website</strong> refers to My Body Buddy,
                        accessible from
                        <a
                            href="https://my-body-buddy.com"
                            rel="external nofollow noopener"
                            target="_blank"
                        >
                            https://my-body-buddy.com
                        </a>
                    </p>
                </li>
                <li>
            ...
            <h4 className="font-bold text-lg md:text-xl mt-5">Personal Data</h4>
            <p className="mt-5">
            ...
            <ul className="list-disc px-10">
                ...
                <li>
                    <p className="mt-3">First name and last name</p>
                </li>
                <li>
                    <p className="mt-3">Usage Data</p>
                </li>
            </ul>
            <h4 className="font-bold text-lg md:text-xl mt-5">Usage Data</h4>
            <p className="mt-5">
            ...
            <h4 className="font-bold text-lg md:text-xl mt-5">
            ...
            <ul className="list-disc px-10">
                <li>
                    ...
                    <p className="mt-5">Type: Session Cookies</p>
                    <p className="mt-5">Administered by: Us</p>
                    <p className="mt-5">
                ...
                <li>
                    ...
                    <p className="mt-5">Type: Persistent Cookies</p>
                    <p className="mt-5">Administered by: Us</p>
                    <p className="mt-5">
            ...
            <ul className="list-disc px-10">
                <li>
                    <p className="mt-5">Comply with a legal obligation</p>
                </li>
                <li>
                    <p className="mt-5">
                ...
                <li>
                    <p className="mt-5">Protect against legal liability</p>
                </li>
            </ul>
            <h3 className="font-bold text-xl md:text-2xl mt-5">
            ...
            <ul className="list-disc px-10">
                <li className="mt-5">
                    ...
                    <a
                        href="https://my-body-buddy/contact"
                        rel="external nofollow noopener"
                        target="_blank"
                    >
                        https://my-body-buddy/contact
                    </a>
                </li>
            </ul>
        </div>
